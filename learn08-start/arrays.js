function start() {
    ...
    let mLength = months.length;
    
    let mParagraph = "<br>";
    for (let i = 0; i < mLength; i++) {
        mParagraph += "<br>" + months[i] + "</br>";
    }
    mParagraph += "<br>"

    document.getElementById("months").innerHTML = mParagraph;
    ...
    week.pop();
    document.getElementById("pop").innerHTML = week; week.pop();
    ...
    document.getElementById("fruits").innerHTML = fruits; fruits.push(" Orange"); fruits.push(" Watermelon");

    // use the shift function to add a fruit to the front of the list and print to the fruits2 paragraph

    fruits.shift();
    document.getElementById("fruits2").innerHTML = fruits; fruits.shift();
    ...
    languages_sorted = [" Basic", " C++", " COBOL", " JavaScript", " Lua", " Python", " livescript"]
    document.getElementById("reversed").innerHTML = languages_sorted.reverse();
